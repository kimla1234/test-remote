...
export default function About_us_homepage() {
  return (
    <div className="mt-10 ">
      ...
      <div 
        className="absolute opacity-30 bg-green-500 inset-0 bg-cover bg-center"
        style={{
      ...
      <div className="relative flex min-h-[600px] flex-col  items-center justify-center px-4 text-center">
        <div className="max-w-3xl space-y-6  ">
          ...
          <div className="mx-auto text-2xl  text-white/90 ">
          ...
          >
            <div className="rounded-xl  text-xl shadow mt-4 ">
              <a
                className="w-full   flex items-center justify-center px-8 py-3 border border-slate-500 text-base leading-6 font-medium rounded-xl text-slate-800 bg-white hover:bg-blue-600 focus:ring ring-offset-2 ring-pink-400 focus:outline-none transition duration-150 ease-in-out md:py-4 md:text-lg md:px-10"
                href=""
              >
                Learn More
              </a>
